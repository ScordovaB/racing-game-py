...
class TkinterFramework:
    ...
    def set_images(self, background_image_path, icon_image_path):
    ...
    def create_frame(self, border_width):
        '''Create a frame to locate al the widgets of the menu'''
        self.frame = customtkinter.CTkFrame(master=self.root, border_width=border_width)
    ...
    def create_label(self, text, font):
        ...
        self.label = customtkinter.CTkLabel(master=self.frame, text=text, font=font)
        self.label.pack(pady=15, padx=12)
    
    def create_Username_entry(self, placeholder_text, font):
        '''Create an entry to insert in the frame of the menu '''
        self.entry = customtkinter.CTkEntry(master=self.frame, placeholder_text=placeholder_text, font=font)
    ...
    def create_radio_button(self, text, variable, value, font):
        '''Create a radio button to insert in the frame of the menu '''
        self.radio = customtkinter.CTkRadioButton(master=self.frame, text=text, variable=variable, value=value, font=font)
        self.radio.pack(pady=12, padx=10)
    
    def create_separator(self):
        '''Create a separator to insert in the frame of the menu '''
        self.separator = tkinter.ttk.Separator(master=self.frame, orient="horizontal")
    ...
    def create_button(self, text, font, command):
        ...
        self.button = customtkinter.CTkButton(master=self.frame, text=text, font=font, command=command)
        self.button.pack(pady=12, padx=10)

    def create_quit_button(self, text, font):
        '''Create a button to quit the menu '''
        self.button = customtkinter.CTkButton(master=self.frame, text=text, font=font, command=quit ,fg_color="red", text_color="white", hover_color="red4")
        self.button.pack(pady=16,padx=10)

    def set_game_function(self, game_function):
